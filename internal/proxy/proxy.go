// Package proxy routes requests to the dispatcher or directly to upstreams.
package proxy
...
// Handler routes requests to throttled or passthrough handling.
type Handler struct {
	cfg          *config.Config
...
// NewHandler returns a Handler backed by cfg and disp.
